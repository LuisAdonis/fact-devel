...
exports.default = {
    ...
    info: {
        ...
        version: '1.0.0',
        description: 'API completa para el Sistema de Facturación Electrónica con integración al SRI Ecuador. Incluye generación automática de PDFs cuando el SRI confirma la recepción de facturas.',
    },
    paths: {
        '/register': {
            post: {
                ...
                description: 'Crea un usuario y su empresa asociada. Requiere clave maestra para el primer registro o código de invitación para registros posteriores.',
                requestBody: {
                    required: true,
                    content: {
                        'application/json': {
        ...
        '/api/v1/invoice-pdf': {
            get: {
                ...
                description: 'Obtiene una lista de todos los PDFs de facturas que han sido generados automáticamente cuando el SRI confirma la recepción (estado RECIBIDA).',
                security: [{ bearerAuth: [] }],
                parameters: [
                    {
                        name: 'page',
        ...
        '/api/v1/invoice-pdf/{id}/download': {
            get: {
                ...
                description: 'Descarga el archivo PDF de una factura. El PDF se genera automáticamente cuando el SRI confirma la recepción.',
                security: [{ bearerAuth: [] }],
                parameters: [
                    {
                        name: 'id',
        ...
        '/api/v1/invoice-pdf/regenerate/{id}': {
            post: {
                ...
                description: 'Regenera el PDF de una factura que ya fue confirmada por el SRI. Útil si el archivo se perdió o se necesita actualizar el formato.',
                security: [{ bearerAuth: [] }],
                parameters: [
                    {
                        name: 'id',
    ...
    tags: [
        ...
        {
            name: 'PDF Management',
            description: 'Gestión de PDFs generados automáticamente. Los PDFs se crean automáticamente cuando el SRI confirma la recepción de facturas (estado RECIBIDA).',
        },
        {
